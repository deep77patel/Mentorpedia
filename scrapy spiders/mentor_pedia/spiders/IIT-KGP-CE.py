...
# IIT-Kharagpur Civil department
class IIT_KGP_CE(scrapy.Spider):
    # ==== Required Variables: ==== #

    name = 'IIT-KGP-CE'  # Name of spider

    # The allowed domain and the URLs where the spider should start crawling:
    allowed_domains = ["iitkgp.ac.in"]
    start_urls = ['http://www.iitkgp.ac.in/department/CE/faculties']
